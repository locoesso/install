...
echo "/dev/disk/by-uuid/95ec73cc-fa63-450a-aa19-bef9ae6f239c /media/Steam auto nosuid,nodev,nofail,x-gvfs-show,x-gvfs-name=Steam 0 0" | sudo tee -a /etc/fstab
